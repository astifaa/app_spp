                  ...
                  while($d = mysqli_fetch_array($spp)){
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        data-id_kelas="<?php echo $d['nama_kelas']?>"
                        data-kompetensi_keahlian="<?php echo $d['kompetensi_keahlian']?>"
                        data-nama="<?php echo $d['nama']?>"
                        data-tahun="<?php echo $d['tahun']?>"
                        data-nominal="<?php echo $d['nominal']?>"
                        data-id_spp="<?php echo $d['id_spp']?>"
                        >Lihat</a>
                      </td>
                    </tr>
                  <?php } ?>
